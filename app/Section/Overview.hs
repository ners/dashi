...
view Model =
    section_
        ...
        , p_
            []
            [ text "Dashi is a design system for dashboards, built on top of "
            , a_ [href_ "https://haskell-miso.org/"] [text "the Miso frontend framework"]
            , text " using "
            , a_ [href_ "https://haskell.org"] [text "the Haskell programming language"]
            , text "."
            ]
        , p_
            []
