...
view Model =
    section_
        ...
        , p_ [] [text "A progress bar shows the duration of a system process, such as saving or processing changes, uploading and downloading files, and loading or updating an application."]
        , p_ [] [text "Use a progress bar when the process is complex or has a long wait time, and you can determine the percentage of the process that has been completed."]
        ...
        , div_
            ...
            $ [ [ widget . Heading Medium . MisoString.toUpper . tokenName $ size
                , widget ProgressBar{value = Determinate{value = 17, max = 100}, size, appearance = Default}
